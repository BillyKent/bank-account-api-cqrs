...
public class AccountAggregate extends AggregateRoot {
    ...
    public void depositFunds(double amount) {
        ...
        if (amount <= 0) {
            throw new IllegalStateException("The deposit amount must be greater tan zero!");
        }
        raiseEvent(
    ...
    public void withdrawFunds(double amount) {
        ...
        if (amount <= 0) {
            throw new IllegalStateException("The withdraw amount must be greater tan zero!");
        }
        raiseEvent(
